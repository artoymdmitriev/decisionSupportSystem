...
public class ComparisonsController implements Initializable, Observer {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        criteriasList.getSelectionModel().selectedItemProperty().addListener(new ChangeListener() {
            ...
            public void changed(ObservableValue observable, Object oldValue, Object newValue) {
                ...
                if(selectedItem.getValue().getName().equals("Критерии")) {
                    // rate criterias
    ...
    private void setRatesForAlternatives() {
        // TODO
    }

    private void setRatesForCriterias() {
        // TODO
    }

    private void setRatesForSubcriterias() {
        // TODO
    }
}
